...
@section('content')
<?php $pageTitle = 'Detail: ' . $permohonan->no_registrasi; ?>

{{-- Back --}}
<div class="mb-4">
    <a href="{{ route('internal.kabalai.permohonan.index') }}" class="inline-flex items-center gap-1.5 text-sm text-slate-500 hover:text-slate-700 transition-colors">
